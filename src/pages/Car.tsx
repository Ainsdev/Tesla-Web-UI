...
function Car(props: TeslaCarType) {
    const style: string = `text-white snap-always snap-start relative w-screen h-screen flex flex-col justify-between items-center bg-center bg-[url('${props.bgImages[0]}')] bg-cover`
    const style2: string = `snap-always snap-start relative w-screen h-screen flex flex-col justify-between items-center bg-center bg-[url('${props.bgImages[1]}')] bg-cover`
    const style3: string = `snap-always snap-start relative w-screen h-screen flex flex-col justify-between items-center bg-center bg-[url('${props.bgImages[2]}')] bg-cover`
    // const styleWhite: string = `text-white snap-always snap-start relative w-screen h-screen flex flex-col justify-between items-center bg-center bg-[url('${props.bgImages[0]}')] bg-cover`
    return (
        <main className="scroll-smooth snap-y snap-mandatory overflow-hidden" >
            ...
            <section className="snap-always snap-start w-screen h-max p-40 bg-black flex justify-center items-center">
                <div className="grid sm:grid-cols-2 gap-y-5 grid-rows-3 text-white text-center">
                    ...
                    <article className="w-[60vh] h-max p-5 order-2">
                        <h1 className="text-xl font-bold pb-12">{props.data[0].title}</h1>
                        <p className="text-lg px-20">{props.data[0].text}</p>
                    </article>
                    <article className="w-[60vh] h-max order-4">
                        <h1 className="text-xl font-bold pb-12">{props.data[1].title}</h1>
                        <p className="text-lg px-20">{props.data[1].text}</p>
                    </article>
                    <article className="w-[60vh] h-max p-5 order-3">
                        <img src={props.data[1].photo}></img>
                    </article>
                    <article className="w-[60vh] h-max order-4">
                        <img src={props.data[2].photo} />
                    </article>
                    <article className="w-[60vh] h-max p-5 order-5">
